...
va_list list, char f[], int params, int width, int precision, int size);
...
int print_int(va_list vl, char f[],
	int params, int width, int precision, int size);
int print_binary(va_list vl, char f[],
	int params, int width, int precision, int size);
int print_unsigned(va_list vl, char f[],
	int params, int width, int precision, int size);
int print_octal(va_list vl, char f[],
	int params, int width, int precision, int size);
int print_hexadecimal_lowercase(va_list vl, char f[],
	int params, int width, int precision, int size);
int print_hexadecimal_uppercase(va_list vl, char f[],
	int params, int width, int precision, int size);

int printhexa(va_list vl, char map_to[],
char f[], int params, char flag_ch, int width, int precision, int size);

/* print non printable characters */
int print_UppercaseS(va_list vl, char f[],
	int params, int width, int precision, int size);

/* print memory address p task 6*/
int print_address(va_list vl, char f[],
	int params, int width, int precision, int size);
...
int print_reverse(va_list vl, char f[],
	int params, int width, int precision, int size);

/* print a string in rot 13 task 14 */
int print_rot13(va_list vl, char f[],
	int params, int width, int precision, int size);
